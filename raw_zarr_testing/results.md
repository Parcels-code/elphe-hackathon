...
The `CacheStore` operates at the wrong level of abstraction. It caches the *compressed bytes* of zarr chunks in memory. On a cache hit, it skips the disk read — but the rest of the zarr access machinery still runs in full:
